...
- 데이터
    - 2004년 ~ 2019년
    - [코스닥 산업별 수익현황 2004-2019.csv](https://kosis.kr/statisticsList/statisticsListIndex.do?vwcd=MT_ZTITLE&menuId=M_01_01)
    - [코스피 산업별 수익현황 2004-2019.csv](https://kosis.kr/statisticsList/statisticsListIndex.do?vwcd=MT_ZTITLE&menuId=M_01_01)
    - [코스닥 산업별 시가총액 2004-2019.csv](https://kosis.kr/statisticsList/statisticsListIndex.do?vwcd=MT_ZTITLE&menuId=M_01_01)
    - [코스피 산업별 시가총액 2004-2019.csv](https://kosis.kr/statisticsList/statisticsListIndex.do?vwcd=MT_ZTITLE&menuId=M_01_01)
    - [업종별 국내 시장규모 2000-2018.csv](https://istans.or.kr/mainMenu.do)
...
2. 시총, 매출, 영엽이익 관계
    ...
    > 서비스업의 시총대비 매출 비가 다른 산업 대비 눈에 띄게 낮았으나, 영업이익은 큰 차이가 없어 보였다.
...
3. 산업간 시가총액 비율
    ...
    - [preprocessing_norm_max.ipynb](./preprocessing_norm_max.ipynb)
...
```
- [preprocessing_market_size_data.ipynb](./preprocessing_market_size_data.ipynb)
### 3-3. 데이터 병합
#### 데이터 병합
...
```
<img src="https://user-images.githubusercontent.com/18084336/108584073-b0da3d00-7381-11eb-9a6a-ec110cfa4624.png" width="450">

```python
msno.matrix(industry_df);
```

<img src="https://user-images.githubusercontent.com/18084336/108589815-97e28380-73a3-11eb-8fbd-681a3493b3e3.png" width="700">
...
### 3-5. 데이터 시각화
#### - 매출, 시총 관계 탐색
큰 시야에서 산업군이 가지는 특성별 특징을 알고자 하였다.
